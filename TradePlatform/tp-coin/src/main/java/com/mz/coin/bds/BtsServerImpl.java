 ...
 * 
 * @author: shangxl
 * @Date : 2018年3月13日 下午8:13:48
 */
public class BtsServerImpl implements BtsServer {
	private static String coinType = Constant.BTS;
	...
	public JsonResult sendFrom(String amount, String toAddress, String memo) {
		...
		if (chargeAccountMoney.compareTo(money) >= 0) {
			...
			result.setMsg("提币账户可用余额不足,平台需预留"+fee.toString()+coinType);
		}
		return result;
	}
