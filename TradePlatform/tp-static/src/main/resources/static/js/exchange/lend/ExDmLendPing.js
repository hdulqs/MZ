...
define([ 'app', 'hryTable', 'layer' ], function(app, DT, layer) {
    ...
    function controller($scope, $rootScope, $http, $stateParams, $state, hryCore) {
        ...
        if ($stateParams.page == "see") {
            $http.get(HRY.modules.exchange + "lend/exDmLendPing/see/" + $stateParams.id).success(function(data) {
                $scope.formData = data;
            });
        }
        ...
        if ($stateParams.page == "add") {
            ...
            $scope.processForm = function() {
                $http({
                    method : 'POST',
                    url : HRY.modules.exchange + 'lend/exDmLendPing/add',
                    ...
                    if (data.success) {
                        ...
                        window.location.href = '#/exchange/lend/exDmLendPing/list/anon';
                    } else {
        ...
        if ($stateParams.page == "modify") {
            ...
            $scope.processForm = function() {
                ...
                $http({
                    method : 'POST',
                    url : HRY.modules.exchange + 'lend/exDmLendPing/modify',
                    data : $.param($scope.formData),
                    headers : {
                        'Content-Type' : 'application/x-www-form-urlencoded'
                    }
        ...
        if ($stateParams.page == "list") {
            ...
            config.ajax.url = HRY.modules.account + 'lend/exDmLendPing/list.do';
            ...
            function fnConfirm() {
                ...
                if (ids.length == 0) {
                    ...
                    $scope.fnConfirmSubmit = function() {
                        ...
                        $http({
                            method : 'POST',
                            url : HRY.modules.account + 'lend/exDmLendPing/confirm',
                            params : {
                                'id' : id,
                                'lengPing':lengPing,
            ...
            function fnInvalid1() {
                ...
                if (ids.length == 0) {
                    ...
                    $scope.fnInvalidSubmit = function() {
                        ...
                        $http({
                            method : 'POST',
                            url : HRY.modules.account + 'lend/exDmLendPing/invalid',
                            data : $.param(param),
                            headers : {
                                'Content-Type' : 'application/x-www-form-urlencoded'
                            }
            ...
            function fnInvalid() {
                ...
                if (ids.length == 0) {
                    ...
                    $http({
                        method : 'POST',
                        url : HRY.modules.account + 'lend/exDmLendPing/invalids',
                        data : $.param(param),
                        headers : {
                            'Content-Type' : 'application/x-www-form-urlencoded'
                        }
