...
define([ 'app', 'hryTable', 'layer','pikadayJq' ], function(app, DT, layer) {
    ...
    function controller($scope, $rootScope, $http, $stateParams, $state, hryCore) {
        ...
        if ($stateParams.page == "see") {
            $http.get(HRY.modules.exchange + "lend/appColdAccountRecord/see/" + $stateParams.id).success(function(data) {
                $scope.formData = data;
            });
        }
        ...
        if ($stateParams.page == "add") {
            ...
            $scope.processForm = function() {
                $http({
                    method : 'POST',
                    url : HRY.modules.exchange + 'lend/appColdAccountRecord/add',
                    ...
                    if (data.success) {
                        ...
                        window.location.href = '#/exchange/lend/appColdAccountRecord/list/anon';
                    } else {
        ...
        if ($stateParams.page == "modify") {
            ...
            $scope.processForm = function() {
                ...
                $http({
                    method : 'POST',
                    url : HRY.modules.exchange + 'lend/appColdAccountRecord/modify',
                    data : $.param($scope.formData),
                    headers : {
                        'Content-Type' : 'application/x-www-form-urlencoded'
                    }
        ...
        if ($stateParams.page == "list") {
            ...
            config.ajax.url = HRY.modules.account + 'fund/appColdAccountRecord/list';
            ...
            config.columnDefs = [ {
                ...
                "render" : function(data, type, row) {
                    if(data==1){
                        return "<font color='green'>增加</font>";
                    }else if(data==2){
                        return "<font color='red'>减少</font>";
                    }
                }
            },{
                "targets" : 3,
            ...
            function fnConfirm() {
                ...
                if (ids.length == 0) {
                    ...
                    $scope.fnConfirmSubmit = function() {
                        ...
                        $http({
                            method : 'POST',
                            url : HRY.modules.account + 'lend/appColdAccountRecord/confirm',
                            params : {
                                'id' : id,
                                'lengPing':lengPing,
            ...
            function fnInvalid1() {
                ...
                if (ids.length == 0) {
                    ...
                    $scope.fnInvalidSubmit = function() {
                        ...
                        $http({
                            method : 'POST',
                            url : HRY.modules.account + 'lend/appColdAccountRecord/invalid',
                            data : $.param(param),
                            headers : {
                                'Content-Type' : 'application/x-www-form-urlencoded'
                            }
            ...
            function fnInvalid() {
                ...
                if (ids.length == 0) {
                    ...
                    $http({
                        method : 'POST',
                        url : HRY.modules.account + 'lend/appColdAccountRecord/invalids',
                        data : $.param(param),
                        headers : {
                            'Content-Type' : 'application/x-www-form-urlencoded'
                        }
