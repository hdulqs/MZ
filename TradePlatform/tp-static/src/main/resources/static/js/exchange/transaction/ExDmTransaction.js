 ...
 */
define(
    ['app', 'hryTable', 'pikadayJq', 'hryUtil'],
    function (app, DT) {

        // 也可以使用这样的显式注入方式，angular执行controller函数前，会先读取$inject
        app.controller.$inject = ['$scope', , '$location', '$rootScope',
            '$http', '$stateParams'];

        function controller($scope, $location, $rootScope, $http,
                            $stateParams, hryCore) {
            // 初始化js 插件
            ...
            if ($stateParams.page == "RejectedList") {
                ...
                config.ajax.url = HRY.modules.exchange
                    + 'transaction/exdmtransaction/list';
                        ...
                        layer
                            .open({
                                ...
                                yes: function () {
                                    ...
                                    $http
                                        .get(
                                            HRY.modules.exchange
                                            + "transaction/exdmtransaction/post/"
                                            + ids[0])
                                        .success(
                                            function (data) {
                                                ...
                                                if (data.success) {
                                                    ...
                                                    growl
                                                        .addInfoMessage("确认节点数至少为2才可以通过审核");
                                                }
                                            });
                    ...
                    if (ids.length == 0) {
                        ...
                        layer
                            .open({
                                ...
                                + transactionMoney
                                + "个"
                                + '<br>驳回理由：<textarea name="MSG" id="reason" cols=20 rows=4></textarea>'
                                + '<br>TIPS:驳回操作不可逆，请确认转入操作无效'
                                ...
                                yes: function () {
                                    ...
                                    if (reason != "" && reason != null) {
                                        ...
                                        $http(
                                            {
                                                method: 'POST',
                                                url: HRY.modules.exchange
                                                + "transaction/exdmtransaction/stop/"
                                                + ids[0],
                                                data: $
                                                    .param(param),
                ...
                function fnRecord(e) {
                    ...
                    $http.get(
                        HRY.modules.exchange
                        + "transaction/exdmtransaction/record")
                        .success(
                            function (data) {
                                growl.addInfoMessage('刷新成功')
                                table.DataTable().draw();
                                $(e.currentTarget).removeAttr(
                                    "disabled");
            ...
            if ($stateParams.page == "DsuccessList") {
                                ...
                                yes: function () {
                                    ...
                                    if (reason != "" && reason != null) {
                                        ...
                                        $http
                                            .get(
                                                HRY.modules.exchange
                                                + "transaction/exdmtransaction/cancelTransaction?id="
                                                + ids[0])
                                            .success(
                                                function (data) {
                                                    debugger
                                                    if (data.success) {
                                                        growl
                                                            .addInfoMessage('驳回成功  请手动对这个用户转币操作')
                                                        fnList();
                                                    } else {
                                                        growl
                                                            .addInfoMessage(data.msg);
                                                    }
                                                });
                                    } else {
                                        $("#message").html("请填写驳回理由")
                ...
                $scope.fnRechargeList = function () {
                    ...
                    $scope.fnRechargeListSubmit = function () {
                        ...
                        var fileext = f_content.substring(f_content
                            .lastIndexOf("."), f_content.length)
                        ...
                        if (fileext != '.xls' && fileext != '.xlsx') {
                            ...
                            $
                                .ajax({
                                    url: HRY.modules.exchange
                                    + '/account/exdigitalmoneyaccount/rechargeList',
                                    type: 'POST',
                                    data: formData,
                                    async: false,
                                    cache: false,
                            ...
                            /*
                             * $http({ method : 'POST', url : HRY.host +
                             * HRY.modules.exchange +
                             * '/account/exdigitalmoneyaccount/rechargeList',
                             * data : $.param($scope.formData), headers : {
                             * 'Content-Type' : 'multipart/form-data' }
                             * }).success(function(data) { if (data.success) {
                             * growl.addInfoMessage('充值成功')
                             * layer.closeAll(); fnList(); } else {
                             * growl.addInfoMessage('充值失败') } });
                             */
                            /*
                             * $("#fileUpload").action(HRY.host+
                             * HRY.modules.exchange+
                             * '/account/exdigitalmoneyaccount/rechargeList');
                             * $("#fileUpload").submit();
                             */
                            /*
                             * var uploadBtn = $("#upfile"); new
                             * AjaxUpload(uploadBtn, { action : HRY.host+
                             * HRY.modules.exchange+
                             * '/account/exdigitalmoneyaccount/rechargeList',
                             * name : 'myfile', onSubmit : function(file,
                             * ext) { alert("123"); }, onComplete :
                             * function(file, response) { debugger; var resp =
                             * JSON.parse(response)
                             * if(resp!=undefined&&resp.success){
                             * alert(resp) growl.addInfoMessage('批量充值成功')
                             * layer.closeAll(); }else{ layer.msg("上传失败", {
                             * icon: 1, time: 2000 }); } } });
                             */
                        }
            ...
            if ($stateParams.page == "WapplyList") {
                ...
                config.columnDefs = [
                    ...
                    },
                    {
                        ...
                        // "renderValueRule" :
                        // "transactionMoney-fee",//值替换规则
                        "render": function (data, type, row) {
                            if (row.transactionMoney != undefined
                                && row.transactionMoney != ""
                                && row.fee != undefined
                                && row.fee != "") {
                    ...
                    if (ids.length == 0) {
                        ...
                        layer.open({
                            ...
                            yes: function () {
                                 ...
                                 * $http({ method : 'POST', url : HRY.host +
                                 * HRY.modules.account +
                                 * 'fund/apptransaction/checkWithdraw/'+ids,
                                 * headers : { 'Content-Type' :
                                 * 'application/x-www-form-urlencoded' }
                                 * }).success(function(data) { if
                                 * (!data.success) { layer.confirm(data.msg, {
                                 * btn : [ '确定', '取消' ], }, function() {
                                 * excutePost(ids); }); } else {
                                 * excutePost(ids); } });
                                 */
                    ...
                    if (ids.length == 0) {
                        ...
                        layer
                            .open({
                                ...
                                + '<br>驳回理由：<textarea name="MSG" id="reason1" cols=20 rows=4></textarea>'
                                + '<br>TIPS:驳回操作不可逆，请确认提币操作无效。'
                                + '<br><span id="message"  style="color:red"></span>',
                                btn: ['确认', '返回'],
                                yes: function () {
                ...
                function fnPost() {
                    ...
                    if (ids.length == 0) {
                        ...
                        /*layer.open({
                            title: '确认通过',
                            content: '用户账号：' + userName
                            + '<br>提币个数：'
                            + transactionMoney + '个'
                            + '<br>提币手续费：' + fee + '个'
                            + '<br>实际到账个数：' + money + '个'
                            + '<br>TIPS:提币确认操作不可逆，请确认提币个数。',
                            btn: ['提币确认', '返回'],
                            yes: function () {
                                // 关闭提示框
                                layer.closeAll();
                                ...
                                $http(
                                    {
                                        ...
                                        url: HRY.host
                                        + HRY.modules.account
                                        + 'transaction/exdmtransaction/checkWithdraw/'
                                        + id,
                                        headers: {
                                            'Content-Type': 'application/x-www-form-urlencoded'
                                        }
                        ...
                        layer.open({
                            ...
                            yes: function () {
                                // 关闭提示框
                                layer.closeAll();
                                var params = {coinCode : coinCode,transMoney : money}
                                $http(
                                    {
                                        method: 'POST',
                                        url: HRY.modules.account
                                        + 'transaction/exdmtransaction/checkWallet',
            ...
            if ($stateParams.page == "WithdrawList") {
                ...
                config.bAutoSerch = true; // 是否开启键入搜索
                config.ajax.url = HRY.modules.exchange
                    + 'transaction/exdmtransaction/allList?type=2';
                config.ajax.data = function (d) {
            ...
            if ($stateParams.page == "RechargeList") {
                ...
                config.bAutoSerch = true; // 是否开启键入搜索
                config.ajax.url = HRY.modules.exchange
                    + 'transaction/exdmtransaction/allList?type=1';
                config.ajax.data = function (d) {
