var app = angular.module('materializeApp', ['ui.materialize'])
    .controller('BodyController', ["$scope", function ($scope) {
        ...
        $scope.toast = function (message, duration) {
            growl.addInfoMessage(message, duration);
        }
    ...
    .controller('CollapsibleController', ["$scope", function ($scope) {
        ...
        $scope.changePage = function (page) {
            growl.addInfoMessage("Changed to page " + page, 1000);
        }
    }])
    .controller('DateController', ["$scope", function ($scope) {
        ...
        scope.readyCallback = function () {
            growl.addInfoMessage("Modal ready", 1000);
        }
        scope.completeCallback = function () {
            growl.addInfoMessage("Modal complete", 1000);
        }
