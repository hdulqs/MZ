...
public class LendTimes implements Serializable{
	...
	@ApiModelProperty(value = "申请的杠杆倍数", required = false)
	private BigDecimal lendTimes;  //申请的杠杆倍数
	@ApiModelProperty(value = "申请状态1申请中，2审批完", required = false)
	private Integer status;  //申请状态1申请中，2审批完
	@ApiModelProperty(value = "申请状态1申请成功，2审批驳回", required = false)
	private Integer lendTimesStatus;  //申请状态1申请成功，2审批驳回
	@ApiModelProperty(value = "申请的时间", required = false)
