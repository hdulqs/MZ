...
public interface RemoteLendService {
    ...
    * @throws:
    */
    public java.util.List<Lend>   list(Long customerId,String userCode,String currencyType,String website,String  lendCoin);
    public java.util.List<Lend> find(Map<String, String> map);
    public java.util.List<LendIntent> findintent(Map<String, String> map);
    //=================  用一个基础币代替人民币start============================//
	/**
	 * 融基础币:净资产，已借资产，还能借多少
	 * @param customerId
