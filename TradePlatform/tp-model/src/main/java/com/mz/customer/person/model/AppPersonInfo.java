 ...
 */
package com.mz.customer.person.model;
...
public class AppPersonInfo extends BaseModel {
	...
	@Column(name= "otcFinishCount")
	private BigDecimal otcFinishCount;  //otc完成单数 add by zongwei 20180623


	public BigDecimal getOtcFinishCount() {
		return otcFinishCount;
	}

	public void setOtcFinishCount(BigDecimal otcFinishCount) {
		this.otcFinishCount = otcFinishCount;
	}
