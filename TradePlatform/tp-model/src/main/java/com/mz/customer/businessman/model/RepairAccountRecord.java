...
/**
 * @Description:   修复账号操作记录
 * @Author:         zongwei
 * @CreateDate:     2018/6/13 14:14
 * @UpdateUser:    zongwei
 * @UpdateDate:     2018/6/13 14:14
 * @UpdateRemark:   创建
 * @Version:        1.0
 */
@Table(name="repair_account_record")
public class RepairAccountRecord extends BaseModel {
    @Id
