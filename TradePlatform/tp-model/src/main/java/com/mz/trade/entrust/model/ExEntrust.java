...
public class ExEntrust extends BaseExModel {
  ...
  public String toString() {
    return "EcEntrust [id=" + id + ", entrustNum=" + entrustNum + ", customerId=" + customerId
        + ", accountId=" + accountId + ", coinCode=" + coinCode + ", type=" + type + ", status="
        + status + ", entrustPrice=" + entrustPrice + ", entrustNum=" + entrustCount
        + ", entrustTime=" + entrustTime + ", entrustWay=" + entrustWay + ", surplusEntrustNum="
        + surplusEntrustCount + ", source=" + source + ", transactionFee=" + transactionFee
        + ", transactionSum=" + transactionSum + ", processedPrice=" + processedPrice
        + ", entrustSum=" + entrustSum + ", transactionFeeRate=" + transactionFeeRate + "]";
  }
