 ...
 */
package com.mz.exchange.transaction.model;
...
public class ExDmTransaction extends BaseModel {
	...
	public ExDmTransaction(Long id, String transactionNum, Long customerId,
	...
	public ExDmTransaction() {
		super();
	}

	@Override
	public String toString() {
		return "ExDmTransaction [id=" + id + ", transactionNum="
				+ transactionNum + ", customerId=" + customerId
				+ ", customerName=" + customerName + ", accountId=" + accountId
				+ ", transactionType=" + transactionType
				+ ", transactionMoney=" + transactionMoney + ", status="
				+ status + ", userId=" + userId + ", currencyType="
				+ currencyType + "]";
	}
