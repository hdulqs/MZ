...
public class WebClient {
   ...
   */
	 ...
	 * @throws IOException 
	 */
	public static String[] operateParameter(HttpServletResponse response,String url,String head,String body,String charset) throws IOException{
		String[] ret=new String[2];
		if(url!=null&&!"".equals(url)){
			if(charset!=null&&!"".equals(charset)){
				//环迅的请求数据报文
				String xml = "<Ips><GateWayReq>" +
						head +body +
						"</GateWayReq></Ips>";
				...
				sb.append("<input name='pGateWayReq\'  type=\"hidden\" value=\"");
				sb.append(xml);
				sb.append("\"/>");
				sb.append("</form>");
				sb.append("</body>");
				...
				ret[0]="SUCCESS";
				ret[1]=sb.toString();
				System.out.println("向环迅请求的html:" + sb.toString());
				response.setContentType("text/html; charset=utf-8");
