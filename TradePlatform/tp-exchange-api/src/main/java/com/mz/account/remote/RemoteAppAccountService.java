...
public interface RemoteAppAccountService {
   ...
   * @throws:
   */
  public JsonResult openAccount(AppCustomer appCustomer, AppPersonInfo appPersonInfo,
   ...
   * @throws:
   */
  public String[] unfreezeAccountSelfLendMoney(Long id, BigDecimal unfreezeMoney,
   ...
   * @throws:
   */
  public String[] LendMoneyToHotMoneyAccountSelf(Long id, BigDecimal unfreezeMoney,
      String transactionNum, String remark, Integer isculAppAccount,
      Integer isImmediatelySaveRecord);
   ...
   * @throws:
   */
  public String[] unfreezeAccountThemBuyTranstion(Long id, BigDecimal unfreezeMoney,
      String transactionNum, String remark, Integer isculAppAccount,
      Integer isImmediatelySaveRecord);
  ...
  public Boolean postCommission(BigDecimal money, String customerName, String website,
      String currencyType,
      String userName, String fixPriceCoinCode);

  public Boolean postCommissionNew(BigDecimal money, Long custromerId, String fixPriceCoinCode,
      Integer fixPriceType);
