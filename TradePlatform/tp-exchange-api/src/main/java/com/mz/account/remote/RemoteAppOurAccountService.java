...
public interface RemoteAppOurAccountService {
   ...
   * @param:    @param dmTransaction
   * @param:    @param digAccountNum
   * @param:    @param remark
   * @param:    @param auditor
   * @return: void
   * @Date :          2017年8月20日 上午10:26:28
   * @throws:
   */
  public void ourAccountChange(AppOurAccount ourAccount,
      AppIcoCoinTransaction coinTransaction, String digAccountNum, String remark,
      String auditor);
