...
public interface RemoteExSubscriptionService {
   ...
   * @throws:
   */
  public JsonResult remoteAddRecord(Long customerId, Long planId, String currentPrice,
      String buyTotalNum, String currencyType, String website, String accountPassword);
