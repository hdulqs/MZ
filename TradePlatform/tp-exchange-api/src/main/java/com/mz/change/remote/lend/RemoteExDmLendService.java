 ...
 */
package com.mz.change.remote.lend;
...
public interface RemoteExDmLendService {
   ...
   * @throws:
   */
  public java.util.List<ExDmLend> list(Long customerId, String userCode, String currencyType,
      String website, String lendCoin);
