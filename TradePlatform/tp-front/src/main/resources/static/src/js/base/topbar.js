...
//		    $("#slide_lang_box a").html('<i class=\'icon_lang icon_lang_'+yy1.toLowerCase()+'\'></i>'+yy);
      ...
      $("#slide_lang_box").html(
          '<a id=\'tt1\'>' + '<i class=\'icon_lang icon_lang_'
          + yy1.toLowerCase() + '\'></i>' + yy + '</a>'
          + '<a  id=\'tt2\'><i class=\'icon_lang icon_lang_' + tt1.toLowerCase()
          + '\'></i>' + tt + '</a>');
      $("#slide_lang dt").on('click', function () {
        ...
        if ($("#tokenId").val() != "") {
          if ($("#language").val() == "zh_CN") {
            $("#slide_lang_box a[id='tt1']").attr("href",
                _ctx + "?lang=en&split=" + split + "&tokenId="
                + $("#tokenId").val());
            $("#slide_lang_box a[id='tt2']").attr("href",
                _ctx + "?lang=tn&split=" + split + "&tokenId="
                + $("#tokenId").val());
