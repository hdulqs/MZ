...
var handleSidebarMenu = function() {
  ...
  //香港未来/
	...
	$('.exuser-left h3').on('click','a',function(){
	      var parH=$(this).parent();
	      parH.addClass('active').siblings().removeClass('active');
	      parH.siblings().find('li').removeClass('active');
	      if(parH.find('i').length){
	    	 return;
	    	    
	      }else{
	    	  parH.append('<i class="fr iconfont icon-jiantouyou"></i>') 
	      }
	      
	    })
	    $('.exuser-left ul li').on('click',function(){
	      var parH=$(this).parent().siblings();
	      $(this).addClass('active').siblings().removeClass('active');
	      parH.removeClass('active').find('li').removeClass('active');
	      parH.find('i').remove();
	    })
    ...
    $(".sidebar .nav > .has-sub > a").click(function() {
        ...
        if ($(".page-sidebar-minified").length === 0) {
            $(t).closest("li").removeClass("expand")
            $(e).slideToggle(250,
            function() {
    ...
    $(".sidebar .nav > .has-sub .sub-menu li").on('click',function(){
