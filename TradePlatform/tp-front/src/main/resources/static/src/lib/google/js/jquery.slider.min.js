        ...
        sliderMouseup: function() {
            ...
            t(s).on("mouseup.slider", function() {
                if (i.sliderBtn_left != i.maxLeft) {
                   ...
                   $('.ddd').show();
                   i.ele.find(".ui-slider-text").text(i.opts.validateMsg).css({
                       color: i.opts.successColor
                   });
                  i.ele.find(".ui-slider-btn").addClass("iconfont icon-baocuo");
                  
                   $('#nc_1_scale_submit').on('click',function(){
        					...
        					success : function(data) {
        						if(data){
        							if(data.success){
        			                     ...
        			                     i.ele.find(".ui-slider-btn").attr("class","ui-slider-btn init ui-slider-no-select success");
        			                     $('.ddd').slideUp();
        			                     $("#btn-ok").removeAttr("disabled");
        							}else{
        								 i.ele.find(".ui-slider-text").text("验证码错误").css({
        			                         color: i.opts.successColor
        			                     });
