...
<link rel="stylesheet" href="${ctx}/static/src/css/otc/otc.css?v=20180522">
<div class="container-fluid person-con">
	...
	<div class="row">
			...
			<!-- end col-12 -->
                ...
                <div class="row">
                   <!--  备注：剩余可交易量小于最低交易量时系统自动退回至账户可用数量中并完成订单。 -->
                    <@spring.message code="beizhu"/>
                </div>
						
						
				<table   id="otcliststable"
...
seajs.use(["js/front/user/otclist"],function(o){
	o.init();
});
