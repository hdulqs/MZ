				...
				<!-- begin col-12 -->
					<div class="col-md-12 col-sm-12">
						<ul class="fund-raise">
						  ...
						  <li><label><@spring.message code="ganganbeishu"/>：</label><span class="red" id="lendTimes">${lendTimes} </span><@spring.message code="beishu"/></li>
			  ...
			  <form  name="lendFrom" id="lendFrom"  >
			  	   <div class="toloanBody col-md-12 col-sm-12" style="padding-left:190px;">
						<div class="loanText">
							<ul>
								<li>
									<span class="title">${coinCodeForRmb}:<@spring.message code="jieru"/>：</span>
									<span>
						...
						<div style="margin-left:120px;margin-top: 20px;">
							<label style="cursor: pointer;">
								<span style="display:inline-block;">
								   <span style="float:left;"><input id="readCheck" type="checkbox"></span><span style="float:none;margin-left:10px;color: #767676;"> <@spring.message code="woyiyuedu"/>
				...
				<div class="row" style="margin-bottom:15px;">
					<div class="panel_wrap_head wrap_head">
						<div class="">
							<ul class="wrap_tabs">
								<li role="presentation" class="active pull-left">
									<a href="javascript:void(0);"><@spring.message code="ganganjilu"/> <div id="netAsseToLend">(${netAsseToLend}%)</div></a>
...
seajs.use(["js/front/user/lendMoney","js/front/user/common"],function(rmb){
	rmb.init();
});
</script>