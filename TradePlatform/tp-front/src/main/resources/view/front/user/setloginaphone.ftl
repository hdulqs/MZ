                    ...
                    <form id="bind-form" action="" method="post" class="">
                   	<!-- <input type="hidden" value="${phone}" class="phone" />
                        <div style="line-height:50px;">
                            ...
                            <span style="color: red;margin-left:5px;">${phone}</span>
                        </div>
                        <div class="filed">
                        ...
                        <div class="filed"><label></label><span class="btn btn-orange " id="submitBtn" style="margin-left:4px;"><@spring.message code="guanbidengluyanzheng"/></span></div>
                    </form>
                </div>
            </div>
        </div>
...
seajs.use(["js/front/user/setloginaphone","js/i18n_base"],function(o){
	o.init();
	/* o.sendsms(); */
