...
<!--pitch content start--> 
            ...
            <div class="banner-bg">
                <div class="banner-center">
                    <div class="banner-process clearfix">
                        ...
                        <div class="proce done"></div>
                        <div class="node node-three ready">
                            <svg class="icon-proce" height="60px" width="60px" viewBox="0 0 60 60">
        ...
        <div class="pay-container ico-container">
            ...
            <!-- the part three of pay process -->
            <div class="pay-part pay-part-three" style="display:block;">
                <div class="funds-payment">
                    <div class="part-three-header">
                        <div class="funds-payment-left">
                            <div class="payment-left-top">
                                <div class="payment-left-title">您需要支付金额</div>
                                <span class="payment-left-val">0.00</span>
                                <span class="order-money-type">
                                    <svg height="40px" width="25px" viewBox="0 0 12.822 21.958">
                                            <path fill="currentColor" d="M9.289 9.759c1.135.313 2.008.883 2.62 1.709.607.826.914 1.824.914 2.994 0 1.692-.6 3.067-1.799 4.123-1.197 1.055-2.751 1.606-4.657 1.658v1.714H4.943v-1.689H0V1.347h4.943V0h1.423v1.347c1.846.025 3.238.392 4.174 1.099.936.707 1.405 1.802 1.405 3.285 0 .788-.24 1.544-.719 2.268a4.533 4.533 0 0 1-1.938 1.646v.114h.001zm-4.345-.737v-5.54H2.492v5.54h2.452zm0 9.086v-6.977H2.492v6.977h2.452zm1.423-9.111a3.522 3.522 0 0 0 2.047-.686c.602-.44.901-1.215.901-2.326 0-.813-.221-1.404-.661-1.772-.44-.368-.994-.586-1.664-.654-.109 0-.317-.017-.623-.051v5.489zm0 9.06c1.118-.051 2.035-.357 2.751-.922.715-.563 1.073-1.42 1.073-2.572 0-.891-.125-1.538-.375-1.945-.25-.406-.663-.75-1.239-1.036-.576-.284-1.313-.426-2.21-.426v6.901z"></path></svg>
                                  </span>
                            </div>
                            <div class="payment-left-bottom">
                                <span class="payment-time-left">剩余有效支付时间</span>
                                <input type="hidden" id="remain_time" value="">
                                <div class="time-count-down">
                                    <span class="time-clock time-minute-tens">3</span>
                                    <span class="time-clock time-minute-ones">0</span>
                                    <span class="time-point">:</span>
                                    <span class="time-clock time-second-tens">0</span>
                                    <span class="time-clock time-second-ones">0</span>
                                </div>
                                <span class="payment-tips">您必须在以上剩余时间内完成支付，否则该投资将会过期无效！</span>
                            </div>
                        </div>
                        <div class="funds-payment-right">
                            <div class="payment-right-title">支付方式:${coinType}在线支付</div>
                            <div class="inline-block">
                                <div class="payment-right-top">
                                    <div class="payment-right-tips">您当前账户余额：
                                        <span id="btc_symbol">
                                          <svg height="12px" width="7px" viewBox="0 0 12.822 21.958">
                                          <path fill="currentColor" d="M9.289 9.759c1.135.313 2.008.883 2.62 1.709.607.826.914 1.824.914 2.994 0 1.692-.6 3.067-1.799 4.123-1.197 1.055-2.751 1.606-4.657 1.658v1.714H4.943v-1.689H0V1.347h4.943V0h1.423v1.347c1.846.025 3.238.392 4.174 1.099.936.707 1.405 1.802 1.405 3.285 0 .788-.24 1.544-.719 2.268a4.533 4.533 0 0 1-1.938 1.646v.114h.001zm-4.345-.737v-5.54H2.492v5.54h2.452zm0 9.086v-6.977H2.492v6.977h2.452zm1.423-9.111a3.522 3.522 0 0 0 2.047-.686c.602-.44.901-1.215.901-2.326 0-.813-.221-1.404-.661-1.772-.44-.368-.994-.586-1.664-.654-.109 0-.317-.017-.623-.051v5.489zm0 9.06c1.118-.051 2.035-.357 2.751-.922.715-.563 1.073-1.42 1.073-2.572 0-.891-.125-1.538-.375-1.945-.25-.406-.663-.75-1.239-1.036-.576-.284-1.313-.426-2.21-.426v6.901z"></path></svg>
                                          </span>
                                        <strong class="my-balance"><span id="hotMoney">${appIcoCoinAccountDTO.hotMoney}</span></strong>
                                    </div>
	                                <input type="hidden" id="projectId" value="${projectId}"/>
	                                <input type="hidden" id="proportions" value="${proportions}"/>
	                                
                                    <input class="payment-btc-address" id="should_pay" value="<#if getMoney??>${getMoney}<#else>1</#if>">
                                    </input>
                                    <a href="javascript:void(0);" class="pay-immediately on" id="immediatePayment">立即支付</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="part-three-footer">
                        <div class="funds-pre-operate">
                        </div>
                        <div class="funds-next-operate">
                            <button type="button" id="three_next_btn">完成
