package com.mz.exchange.websocketclient.clienthandler;
...
public class MyWebSocketClient {
	private String url =PropertiesUtils.APP.getProperty("app.socketUrl")
			+ "/websocket";
//	private String url ="ws://47.75.200.109:6062/hurong_socketserver/chatsocket";
	...
	public void connect() throws Exception {
		...
		final String host = uri.getHost() == null ? "47.75.200.109" : uri.getHost();
		final int port;
		if (uri.getPort() == -1) {
