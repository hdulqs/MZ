...
public class TotalAccountForReport {
	...
	private BigDecimal finalMoney; //期末总资金
	
	private BigDecimal numfee;   //平台自持总金额
	
	private BigDecimal finalMoneyNew; //平台总余额
	
	private BigDecimal lendCount; //杠杆总金额
	
	private BigDecimal unleveragedNumber; //杠杆总利息
	
	private BigDecimal interestCount;  //未还杠杆个数
	
	private BigDecimal unpaidNumber;   //未还利息金额
	
	private BigDecimal transactionCount;//卖总数
	...
	public BigDecimal getFinalMoneyNew() {
		return finalMoneyNew;
	}

	public void setFinalMoneyNew(BigDecimal finalMoneyNew) {
		this.finalMoneyNew = finalMoneyNew;
	}
