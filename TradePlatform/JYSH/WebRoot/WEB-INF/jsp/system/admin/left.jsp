		...
		<div id="sidebar" class="menu-min">
				...
				<div id="sidebar-shortcuts">
					...
					<div id="sidebar-shortcuts-large">
						...
						<button class="btn btn-small btn-success" id="admincaidan" onclick="changeMenu();" title="切换菜单"><i class="icon-pencil"></i></button>

						<button class="btn btn-small btn-info" id="adminUI" title="UI实例" onclick="window.open('<%=basePathl%>static/UI_new');"><i class="icon-eye-open"></i></button>
