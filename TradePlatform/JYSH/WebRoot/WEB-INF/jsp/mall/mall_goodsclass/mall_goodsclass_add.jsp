...
<script type="text/javascript">
	...
	//加载下级下拉选项 
	function selectSon_id(){
		$.ajax({
			type:"POST",
			url : 'mall_goodsclass/optionList.do?LEVEL=1',
			success : function(result) {
				$("#SON_ID").append(result);
			}
		});
	}
...
<body onload="init()">
	<form action="mall_goodsclass/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">关联下级:</td>
					<td>
