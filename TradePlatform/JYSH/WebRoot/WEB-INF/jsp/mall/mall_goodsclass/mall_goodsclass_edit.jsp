	...
	<form action="mall_goodsclass/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input type="text" name="CLASSNAME" id="CLASSNAME" value="${pd.CLASSNAME}" maxlength="32" placeholder="这里输入分类名称" title="分类名称"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<c:if test="${pd.DISPLAY =='false'}">
						<input name="DISPLAY" id="DISPLAY" class="ace-switch ace-switch-5" type="checkbox"/><span class="lbl"></span>
					</c:if>
					<c:if test="${pd.DISPLAY =='true'}">
						<input name="DISPLAY" id="DISPLAY" class="ace-switch ace-switch-5" type="checkbox" checked="checked"/><span class="lbl"></span>
					</c:if>
				</td>
			</tr>
			<tr>
				...
				<td>
					<c:if test="${pd.RECOMMEND =='false'}">
					<input name="RECOMMEND" id="RECOMMEND" class="ace-switch ace-switch-5" type="checkbox" /><span class="lbl"></span>
					</c:if>
					<c:if test="${pd.RECOMMEND =='true'}">
					<input name="RECOMMEND" id="RECOMMEND" class="ace-switch ace-switch-5" type="checkbox" checked="checked"/><span class="lbl"></span>
					</c:if>
				</td>
			</tr>
			<tr>
