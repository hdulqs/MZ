...
public class ImgFillWordUtil {

    public static void main(String[] args) {
        String filePath = "D:\\chen\\1.png";
        String outPath = "d:\\chen\\3.png";
        drawTextInImg(filePath, outPath, new FontText("中国", 3, "#CC2BAC", 40, "黑体"));
    ...
    public static void drawTextInImg(String filePath,String outPath, FontText text) {
        ...
        Font font = null;
        if (!CommonUtils.isEmptyString(text.getWm_text_font())
