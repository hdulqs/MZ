...
public class Mapper {
	 ...
	 * @throws JsonParseException
	 */
	public static <T> Map<Object, Object> jsonToMap(String json) {
	...
	public static <T> Object JSONToObj(String jsonStr, Class<T> obj) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("json转换成object时报错");
		}
		return t;
	}
	...
	/*
	 * @Test public void aaa() { Person person1 = new Person();
	 * person1.setAddress("address"); person1.setAge(11);
	 * person1.setName("amao");
	 * 
	 * Person person2 = new Person(); person2.setAddress("address");
	 * person2.setAge(11); person2.setName("amao");
	 * 
	 * List<Person> lp = new ArrayList<Person>(); lp.add(person1);
	 * lp.add(person2);
	 * 
	 * // String serialize = serialize(lp); // JSONObject jsonObject =
	 * JSONObject.fromMap();
	 * 
	 * try { List<Map> list = this.getList(lp);
	 * System.out.println(list.toString()); //Object p =
	 * convertMap(Person.class,map); //System.out.println(p.toString()); } catch
