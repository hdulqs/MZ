...
public class SmsSendUtil {
  ...
  public final static String GOOGLE_KEY = "sms_take_google";
  /**
   * 海外手机认证
   */
   ...
   * @throws:
   */
  public static String sendSmsCode(SmsParam smsParam, String phoneType, String phone) {
    ...
    SmsInfoRunable smsInfoRunable = new SmsInfoRunable(url, smsParam, phoneType, phone, null,
        null);
    ThreadPool.exe(smsInfoRunable);
    return code;
  }
   ...
   * @throws:
   */
  public static String sendSmsCode(SmsParam smsParam, Map<String, Object> map) {
    int length = 6;//6位短信验证码
    //请求路径
    String url = PropertiesUtils.APP.getProperty("app.smsUrl") + "/sdk/send";
    //生成随机码
    ...
    SmsInfoRunable smsInfoRunable = new SmsInfoRunable(url, smsParam, null,
        smsParam.getHryMobilephone(), null,
        map);
    ThreadPool.exe(smsInfoRunable);
   ...
   * @param: @return
   * @return: String
   * @Date :          2017年2月17日 下午5:59:28
   * @throws:
   */
  public static void alisendSmsCode(AppSmsSend appSmsSend, SmsParam smsParam) {
    AliSmsRunable aliSmsRunable = new AliSmsRunable(appSmsSend, smsParam);
    ThreadPool.exe(aliSmsRunable);
  }
  ...
  public static String getSendTypeValue(String hrySmstype) {
    if (REGIST.equals(hrySmstype)) {
      ...
      return "提现或提币(前台)";
    } else if (GOOGLE_KEY.equals(hrySmstype)) {
      return "谷歌验证";
  ...
  public static boolean sendSmsInfo(SmsParam smsParam, String phoneType, String phone,
      String syscode, Map<String, Object> map) {
    //请求路径
    String url = PropertiesUtils.APP.getProperty("app.smsUrl") + "/sdk/send";
    SmsInfoRunable smsInfoRunable = new SmsInfoRunable(url, smsParam, phoneType, phone, syscode,
        map);
    ThreadPool.exe(smsInfoRunable);
    return true;
  }
