 ...
 */
@Controller
@RequestMapping("/fund/apphotaccountrecord")
public class AppHotAccountRecordController {
  ...
  public PageResult list(HttpServletRequest request) {
    ...
    return remoteAppAccountRecordService.findAppHotAccountRecordList(parameterMap);
  }
