...
public class RemoteAppTransactionServiceImpl implements RemoteAppTransactionService {
  ...
  @Override
  public List<AppTransaction> record(Long id, String type, String status, String beginDate,
      String endDate, String currencyType, String website) {
  ...
  /* (non-Javadoc)
   * @see RemoteAppTransactionService#update(com.mz.account.fund.model.AppTransaction)
   */
  @Override
