...
public class CommissionDeployServiceImpl extends BaseServiceImpl<CommissionDeploy, Long> implements
    CommissionDeployService {
   ...
   *
   * index 1 表示 表示 第一级父 index 2 表示 表示 第二级父 index 3 表示 表示 第三级父
   */
  @Override
  public List<AppAgentsCustromer> findByTransaction(String userName) {
    ...
    if (null != userName) {
      AppAgentsCustromer agentsCustromer1 = appAgentsCustromerService
          .findAgentsByCustromer(userName, 1);
      ...
      AppAgentsCustromer agentsCustromer2 = appAgentsCustromerService
          .findAgentsByCustromer(userName, 2);
      ...
      AppAgentsCustromer agentsCustromer3 = appAgentsCustromerService
          .findAgentsByCustromer(userName, 3);
...
//		}
   ...
   */
  @Override
  public BigDecimal selectCommissionByMoney(BigDecimal money, Integer commissionType,
      Integer rank) {
