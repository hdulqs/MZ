...
public class AppAgentsCustromerServiceImpl extends
    BaseServiceImpl<AppAgentsCustromer, Long> implements AppAgentsCustromerService {
   ...
   */
  @Override
  public PageResult findAgentsForMoney(QueryFilter filter, String agentName,
    ...
    List<AgentsForMoney> list = appAgentsCustromerDao
        .findAgentsForMoney(agentName, fixPriceCoinCode);
    //----------------------查询结束------------------------------
