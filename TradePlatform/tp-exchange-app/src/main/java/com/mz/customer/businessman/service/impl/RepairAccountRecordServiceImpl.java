...
public class RepairAccountRecordServiceImpl extends
  ...
  public synchronized void saveRecord(Long customId, Long accountId, BigDecimal money,
    ...
    RepairAccountRecord repairAccountRecord = new RepairAccountRecord();
    repairAccountRecord.setAcccountType(acccountType);
    repairAccountRecord.setMonteyType(monteyType);
    repairAccountRecord.setAccountId(accountId);
    repairAccountRecord.setCustomId(customId);
    repairAccountRecord.setMoney(money);
    repairAccountRecord.setTransactionNum(transactionNum);
    repairAccountRecord.setRemarks(remarks);
    super.save(repairAccountRecord);
  }
