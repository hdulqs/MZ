...
public interface ExEntrustService extends BaseService<ExEntrust, Long> {
   ...
   * @throws:
   */
  public String getExEntrustChange(String coinCode, Integer type, String depth, Integer n,
      String customerType);
   ...
   * @throws:
   */
  public String getExEntrustChangeMarket(String coinCode, String depth, Integer n,
      String customerType);
   ...
   * @throws:
   */
  public String getExEntrustChangeDephMarket(String coinCode, String customerType, Integer n,
      BigDecimal depth);
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchByBuyLimitedPrice(String saasId, ExEntrust buyexEntrust,
      String customerType); //买家限价（必须相等才匹配）
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchByBuyMarketPrice(String saasId, ExEntrust buyexEntrust,
      String customerType); ////买家市价 	//只要未完成的卖家都可以
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchBySellLimitedPrice(String saasId, ExEntrust buyexEntrust,
      String customerType); ////卖家限价  //必须相等才匹配
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchBySellMarketPrice(String saasId, ExEntrust buyexEntrust,
      String customerType); //////卖家市价 //只要未完成的卖家都可以
   ...
   * @throws:
   */
  public void cancelAlltypeExEntrust(Integer type, String currencyType, String website,
   ...
   * @throws:
   */
  public void cancelCustAllCoinCodeExEntrust(Long custtomerId, String currencyType, String website,
      String CoinCode);
   ...
   * @throws:
   */
  public Map<String, BigDecimal> getExEntrustmMostPrice(String coincode, int type,
      List<Integer> customerType);
   ...
   * @throws:
   */
  public List<ExEntrust> getExEntrustByPrice(String coincode, int type, String customerType,
   ...
   * @throws:
   */
  public String getHeader(String website, String currencyType, String coinCode,
      String fixPriceCoinCode);
