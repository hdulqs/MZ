 ...
 */
package com.mz.trade.exEntrustOneDay.dao;
...
public interface ExentrustOnedayDao extends BaseDao<ExentrustOneday, Long> {
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchByBuyMarketPrice(
      Map<String, Object> map); ////买家市价 	//只要未完成的卖家都可以
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchBySellLimitedPrice(
      Map<String, Object> map); ////卖家限价  //必须相等才匹配
   ...
   * @throws:
   */
  public List<ExentrustOneday> listMatchBySellMarketPrice(
      Map<String, Object> map); //////卖家市价 //只要未完成的卖家都可以
