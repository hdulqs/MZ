...
public class YunPianUtils {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
	   ...
	   // String decode = java.net.URLDecoder.decode(mobile,"UTF-8");
	    //**************** 查账户信息调用示例 *****************//*
	    System.out.println(YunPianUtils.getUserInfo(apikey));
	    ...
	    //发短信调用示例
	   System.out.println(YunPianUtils.sendSms(apikey, text, mobile));
	   ...
	   // String tpl_value = "#code#=" + codeValue + "&#company#=云片网";
	    //模板发送的调用示例
	   // System.out.println(YunPianUtils.tplSendSms(apikey, tpl_id, tpl_value, mobile));

	   //**************** 使用接口发语音验证码 *****************//*
	   // String code = "1234";
	  //  System.out.println(YunPianUtils.sendVoice(apikey, mobile ,code));
	}
