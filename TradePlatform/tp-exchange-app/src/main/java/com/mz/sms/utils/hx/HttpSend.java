...
public class HttpSend {
  ...
  public static void main(String[] args) {
    ...
    String[] s = {transfer_id, status, txid, request_time, reason, symbol, from, to, coins, fee,
        transfer_type, Secret};
    //数组字典排序
  ...
  public static void main22(String[] args) {
    ...
    String validation_code = "com.mz";
    String validation_phone = "18911192929";

    String[] s = {app_key, request_time, transfer_type, symbol, type, coins, from_wallet, to_wallet,
        transfer_id,
