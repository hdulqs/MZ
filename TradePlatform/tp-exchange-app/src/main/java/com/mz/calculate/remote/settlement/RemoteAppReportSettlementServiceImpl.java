...
public class RemoteAppReportSettlementServiceImpl implements RemoteAppReportSettlementService {
  ...
  @Override
  public Integer getIsShowExSettlementFinance(Long customerId, String currencyType,
      String website) {
    // TODO Auto-generated method stub
    return appReportSettlementService
        .getIsShowExSettlementFinance(customerId, currencyType, website);
  }
  ...
  public AppReportSettlementcoin selectExSettlementcoinBycoincode(
      Long customerId, String coinCode, String currencyType, String website, String beginDateString,
  ...
  public List<AppReportSettlementcoin> selectExSettlementcoin(
      Long customerId, String currencyType, String website, String beginDateString,
      String endDateString) {
    QueryFilter filter = new QueryFilter(AppReportSettlementcoin.class);
    filter.addFilter("customerId=", customerId);
    filter.addFilter("currencyType=", currencyType);
  ...
  /* (non-Javadoc)
   * @see RemoteAppReportSettlementService#changeClosePlateTime(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see RemoteAppReportSettlementService#changeCloseTime(java.lang.String)
   */
  @Override
