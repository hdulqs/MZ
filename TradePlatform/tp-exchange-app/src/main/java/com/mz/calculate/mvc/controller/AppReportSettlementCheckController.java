 ...
 */
@Controller
@RequestMapping(value="/appReportSettlement")
public class AppReportSettlementCheckController extends BaseController<AppReportSettlement, Long>
{
	...
	public JsonResult culAccountAllCustomer(HttpServletRequest request){
		JsonResult jsonResult = new JsonResult();
		remoteAppReportSettlementCheckService.culAccountAllCustomer();
		jsonResult.setSuccess(true);
		return jsonResult;
	}
	...
	public PageResult operationAccountFundInfoLogList(){
		...
		list=JSON.parseArray(redisService.get("operation_accountfundinfo_log"), OperationAccountFundInfoLog.class);
	    if(null==list){
