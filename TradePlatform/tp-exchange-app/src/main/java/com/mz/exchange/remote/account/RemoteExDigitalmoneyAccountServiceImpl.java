...
import com.mz.exchange.entrust.dao.ExExOrderInfoDao;
...
public class RemoteExDigitalmoneyAccountServiceImpl implements
  ...
  public String putOrder(OrderParameter order) {
    try {
      ...
      exDmTransaction.setTrueName(order.getTrueName());
      ...
      e.printStackTrace();
      System.out.println("---------调用接口保存充值订单报异常--------- ");
    }
    return "NO";
  ...
  public String setOrder(OrderParameter order) {
    ...
    ExDigitalmoneyAccount digitalmoneyAccount = this
        .findByCustomerType(order.getCustomerId(), order.getCurrencyType(), order.getType(),
            order.getWebsite());
    ...
    exDmTransaction.setCustomerName(order.getCustomerName());
    exDmTransaction.setTrueName(order.getTrueName());
    exDmTransaction.setSurname(order.getSurname());
		/*exDmTransaction.setBtcDate(order.getBtcDate());
		  exDmTransaction.setBtcCount(order.getBtcCount());*/
    // 2表示提现
    exDmTransaction.setStatus(1);
    ...
    exDmTransactionService.save(exDmTransaction);
		...
		/*this.setColdRecord(order, 1, transactionNum);
		this.setHotRecord(order, 2, transactionNum);
		this.setColdFeeRecord(order, 1, transactionNum);
		this.setHotFeeRecord(order, 2, transactionNum);*/

    //----发送mq消息----start
    //热账户减少
    System.out.println(digitalmoneyAccount.getId() + "：提币消息生产者开始");
    ...
    System.out.println(digitalmoneyAccount.getId() + "：提币消息生产者结束");
    //----发送mq消息----end
  ...
  @Override
  public ExDigitalmoneyAccount findByCustomerType(Long id, String coinCode, String currencyType,
      String website) {
  ...
  @Override
  public HashMap<String, BigDecimal> getAllNetAsset(Long customerId, String coinCode,
  ...
  public HashMap<String, BigDecimal> getByTypeNetAsset(Long customerId, String coinCode,
      String currencyType, String website) {
    return exDigitalmoneyAccountService
        .getByTypeNetAsset(customerId, coinCode, currencyType, website);
  }

  /* (non-Javadoc)
   * @see com.mz.exchange.remote.account.RemoteExDigitalmoneyAccountService#getAllCanLendMoney(java.lang.Long)
   */
  @Override
  public HashMap<String, BigDecimal> getAllCanLendMoney(Long customerId, String coinCode,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .getAllCanLendMoney(customerId, coinCode, currencyType, website);
  }

  /* (non-Javadoc)
   * @see com.mz.exchange.remote.account.RemoteExDigitalmoneyAccountService#getAllLendMoney(java.lang.Long)
   */
  @Override
  public HashMap<String, BigDecimal> getAllLendMoney(Long customerId, String coinCode,
      String currencyType, String website) {
    // TODO Auto-generated method stub
  ...
  /* (non-Javadoc)
   * @see com.mz.exchange.remote.account.RemoteExDigitalmoneyAccountService#getCanLendMoney(java.lang.Long, java.lang.String)
   */
  @Override
  public BigDecimal getCanLendMoney(Long customerId, String coinCode, String currencyType,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .getCanLendMoney(customerId, coinCode, currencyType, website);
  }

  /* (non-Javadoc)
   * @see com.mz.exchange.remote.account.RemoteExDigitalmoneyAccountService#getRMBLendMoneySum(java.lang.Long)
   */
  @Override
  public BigDecimal getRMBLendMoneySum(Long customerId, String coinCode, String currencyType,
      String website) {
   ...
   * (non-Javadoc)
   *
   * @see com.mz.change.remote.account.RemoteExDigitalmoneyAccountService#getRMBNetAsset(
   *java.lang.Long, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public BigDecimal getRMBNetAsset(Long customerId, String coinCode, String currencyType,
      String website) {
    // TODO Auto-generated method stub
   ...
   */
  @Override
  public BigDecimal getCoinCold(Long customerId, String coinCode, String currencyType,
      String website) {
    // TODO Auto-generated method stub
   ...
   */
  @Override
  public Boolean judgeMoneyByCustromerId(BigDecimal money, Long customerId, String coinCode,
      String currencyType, String website) {

    BigDecimal money2 = exDigitalmoneyAccountService
        .getCanWithdrawMoney(customerId, coinCode, currencyType, website);
   ...
   */
  @Override
  public Boolean judgeCurrencyByCustromerId(BigDecimal currencyNum, Long customerId,
      String coinCode) {

    String currencyType = ContextUtil.getRemoteCurrencyType();
    String website = ContextUtil.getWebsite();
    BigDecimal currencyNum2 = exDigitalmoneyAccountService
        .getCanWithdrawCoin(customerId, coinCode, currencyType, website);
  ...
  public List<DigitalmoneyAccountAndProduct> findDigtalAndProductByWebsite(
    ...
    List<DigitalmoneyAccountAndProduct> digitalAndProduct = exDigitalmoneyAccountService
        .findDigitalAndProduct(webstile, customerName, isMarket);
  ...
  public String[] freezeAccountSelf(Long id, BigDecimal freezeMoney,
      String transactionNum, String remark, Integer isculAppAccount,
      Integer isImmediatelySaveRecord) {
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .freezeAccountSelf(id, freezeMoney, transactionNum, remark, isculAppAccount,
            isImmediatelySaveRecord);
  }
  ...
  public String[] unfreezeAccountSelf(Long id, BigDecimal unfreezeMoney,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .unfreezeAccountSelf(id, unfreezeMoney, transactionNum, remark, isculAppAccount,
            isImmediatelySaveRecord);
  }
  ...
  public String[] unfreezeAccountThem(Long id, BigDecimal unfreezeMoney,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .unfreezeAccountThem(id, unfreezeMoney, transactionNum, remark, isculAppAccount,
            isImmediatelySaveRecord);
  }
  ...
  public String[] inComeToHotAccount(Long id, BigDecimal incomeMoney,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .inComeToHotAccount(id, incomeMoney, transactionNum, remark, isculAppAccount,
            isImmediatelySaveRecord);
  }
  ...
  public String[] payFromHotAccount(Long id, BigDecimal payMoney,
    ...
    // TODO Auto-generated method stub
    return exDigitalmoneyAccountService
        .payFromHotAccount(id, payMoney, transactionNum, remark, isculAppAccount,
            isImmediatelySaveRecord);
  }
  ...
  public String setOrderAppAccount(OrderParameter order) {
    ...
    ExDigitalmoneyAccount digitalmoneyAccount = this
        .findByCustomerType(order.getCustomerId(), order.getType(), order.getCurrencyType(),
            order.getWebsite());
    AppAccount appAccount = RemoteAppAccountService
        .getByCustomerIdAndType(order.getCustomerId(), order.getCurrencyType(), order.getWebsite());
    if (null == digitalmoneyAccount) {
      return "NO";
    }
    ...
    RemoteAppAccountService.freezeAccountSelf(appAccount.getId(),
        exDmTransaction.getTransactionMoney().subtract(exDmTransaction.getFee()),
        exDmTransaction.getTransactionNum(), "提币金额", null, null);
    RemoteAppAccountService.freezeAccountSelf(appAccount.getId(), exDmTransaction.getFee(),
  ...
  public List<ExDigitalmoneyAccount> positionSummary(Long customerId) {
    ...
    for (ExDigitalmoneyAccount l : list) {
      ...
      if (l.getHotMoney().add(l.getColdMoney()).compareTo(new BigDecimal(0)) > 0) {
        ...
        BigDecimal positionAvePrice = buyMoney.subtract(sellMoney)
            .divide(l.getHotMoney().add(l.getColdMoney()), 2, BigDecimal.ROUND_HALF_UP);
        l.setPositionAvePrice(positionAvePrice);
        //end
        String header = l.getWebsite() + ":" + l.getCurrencyType() + ":" + l.getCoinCode();
        String currentExchangPrice = ExchangeDataCache
            .getStringData(header + ":" + ExchangeDataCache.CurrentExchangPrice);
        if (null != currentExchangPrice) {
          BigDecimal currentExchangPricebig = new BigDecimal(currentExchangPrice);
          l.setFloatprofitandlossMoney(currentExchangPricebig.subtract(positionAvePrice)
              .multiply(l.getHotMoney().add(l.getColdMoney())));
          l.setFloatprofitandlossMoneyRate(l.getFloatprofitandlossMoney()
              .divide(buyMoney.subtract(sellMoney), 2, BigDecimal.ROUND_HALF_UP));
        }
  ...
  /* (non-Javadoc)
   * @see RemoteExDigitalmoneyAccountService#findAppAccountDisable(com.mz.util.RemoteQueryFilter)
   */
  @Override
