...
public class LendCoinAccountServiceImpl implements
  ...
  public AppAccount getAppAccount(Long customerId) {
    ...
    AppAccountRedis appAccountredis = UserRedisUtils
  ...
  //  折合成基础币净资产
  @Override
  public BigDecimal getRMBNetAsset(Long customerId, String coinCodeForRmb, String currencyType,
      String website) {
    ...
    BigDecimal acc = appAccount.getHotMoney().add(appAccount.getColdMoney())
        .subtract(appAccount.getLendMoney());
    if (coinCodeForRmb.equals(getRMBCode())) {
      ...
      if (null != currentExchangPrice) {
        rMBappAccountNetAsse = rMBappAccountNetAsse
            .add(acc.divide(currentExchangPrice, 10, BigDecimal.ROUND_HALF_DOWN));
      }
  ...
  // 折合成某币净资产
  @Override
  public BigDecimal getCoinNetAsset(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {

    if (null == coinCodeForRmb) {
      coinCodeForRmb = getCoinCodeForRmb();
    }
    BigDecimal rMBappAccountNetAsse = getRMBNetAsset(customerId, coinCodeForRmb, currencyType,
        website);
    ...
    if (null == currentExchangPrice) {
      ...
      BigDecimal coinAccountNetAsse = rMBappAccountNetAsse
          .divide(currentExchangPrice, 10, BigDecimal.ROUND_HALF_DOWN);
  ...
  //总负责折合成基础币
  @Override
  public BigDecimal getRMBLendMoneySum(Long customerId, String coinCodeForRmb, String currencyType,
      String website) {
  ...
  //总负责折成某币
  @Override
  public BigDecimal getCodeLendMoneySum(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {
    BigDecimal lendSum = getRMBLendMoneySum(customerId, coinCodeForRmb, currencyType,
        website);  //负债
    if (coinCode.equals(coinCodeForRmb)) {
      return lendSum;
    }
  ...
  //所欠利息折合成RMB
  public BigDecimal getRMBLendMoneyInteretSum(Long customerId, String coinCodeForRmb,
      String currencyType, String website) {
    List<ExDigitalmoneyAccount> list = this.getByCustomerId(customerId, currencyType, website);
    //加未偿还的利息
  ...
  //某个币种能借多少
  @Override
  public BigDecimal getCanLendMoney(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {
    if (null == coinCodeForRmb) {
      coinCodeForRmb = getCoinCodeForRmb();
    }
    RemoteAppConfigService remoteAppConfigService = (RemoteAppConfigService) ContextUtil
        .getBean("remoteAppConfigService");
    BigDecimal rMBAccountNetAsse = this
        .getRMBNetAsset(customerId, coinCodeForRmb, currencyType, website);  //净资产
    ...
    if (null != currentExchangPrice) {
      BigDecimal canLendMoney = surMBAccountNetAsse
          .divide(currentExchangPrice, keepDecimalForRmb, BigDecimal.ROUND_HALF_DOWN);
      return canLendMoney;
    }
    return new BigDecimal("0");
  }
   ...
   */
  @Override
  public BigDecimal getCanWithdrawMoney(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {
    ...
    BigDecimal netAsseToLend = this
        .netAsseToLend(customerId, coinCodeForRmb, currencyType, website);
    //杠杆的比例1.1，放文件
    RemoteAppConfigService remoteAppConfigService = (RemoteAppConfigService) ContextUtil
        .getBean("remoteAppConfigService");
   ...
   */
  @Override
  public BigDecimal getCanWithdrawCoin(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {
    ...
    BigDecimal coinNetAsset = this
        .getCoinNetAsset(customerId, coinCodeForRmb, coinCode, currencyType, website); //净资产
  ...
  //资产/杠杆：比例
  @Override
  public BigDecimal netAsseToLend(Long customerId, String coinCodeForRmb, String currencyType,
      String website) {
    if (null == coinCodeForRmb) {
      RemoteAppConfigService remoteAppConfigService = (RemoteAppConfigService) ContextUtil
          .getBean("remoteAppConfigService");
    ...
    BigDecimal rmblendSum = this
        .getRMBLendMoneySum(customerId, coinCodeForRmb, currencyType, website);//折合RMB总负债
    if (null == rmblendSum) {
    ...
    BigDecimal rMBAccountNetAsse = this
        .getRMBNetAsset(customerId, coinCodeForRmb, currencyType, website);//折合RMB净资产
    BigDecimal sumzichan = rMBAccountNetAsse.add(rmblendSum);//总资产=净资产+负债

    return sumzichan.divide(rmblendSum, 10, BigDecimal.ROUND_HALF_DOWN)
  ...
  public List<ExDigitalmoneyAccount> getByCustomerId(Long customerId, String currencyType,
    ...
    while (it.hasNext()) {
      ...
      ExDigitalmoneyAccountRedis appAccount = UserRedisUtils
          .getAccount(userRedis.getDmAccountId(entry.getKey()).toString(), entry.getKey());
      list.add(appAccount);
    }
    ...
    for (ExDigitalmoneyAccount e : liste) {
      ExDigitalmoneyAccountRedis appAccount = UserRedisUtils
          .getAccount(userRedis.getDmAccountId(e.getCoinCode()).toString(), e.getCoinCode());
  ...
  @Override
  public BigDecimal getRMBSum(Long customerId, String coinCodeForRmb, String currencyType,
      String website) {
  ...
  @Override
  public BigDecimal getCoinCodeSum(Long customerId, String coinCodeForRmb, String coinCode,
      String currencyType, String website) {
  ...
  public int culDecimal(String coinCode) {
    ...
    if (coinCode.equals(getRMBCode())) { //如果是法币
      ...
      ExProductService exProductService = (ExProductService) ContextUtil
          .getBean("exProductService");
