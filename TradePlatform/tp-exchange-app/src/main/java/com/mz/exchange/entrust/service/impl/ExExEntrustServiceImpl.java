	...
	*//**
	...
	public void autoAddExEntrust() {
		...
		if(autoOrder_CRTC!=null && "0".equals(autoOrder_CRTC)){
			...
			System.out.println("联合学分开启刷单，设置刷单价格为："+price_CRTC+"，浮动比例为："+priceFloat_CRTC+"，生成的浮动价格:"+truePrice_CRTC.toString()+
		...
		if(autoOrder_LTC!=null && "0".equals(autoOrder_LTC)){
			...
			System.out.println("莱特币开启刷单，设置刷单价格为："+price_LTC+"，浮动比例为："+priceFloat_LTC+"，生成的浮动价格:"+truePrice_LTC.toString()+
		...
		if(autoOrder_BTC!=null && "0".equals(autoOrder_BTC)){
			...
			System.out.println("莱特币开启刷单，设置刷单价格为："+price_BTC+"，浮动比例为："+priceFloat_BTC+"，生成的浮动价格:"+truePrice_BTC.toString()+
