 ...
 */
package com.mz.exchange.product.synced;
...
public class SyncedUserForProduct {
  ...
  public void syncedUser(ExProduct exProduct) {
    ...
    while (iterator.hasNext()) {
      ...
      for (AppCustomer customer : list) {
        ...
        if (old != null) {
          System.out.println("已经存在：------" + customer.getId());
          continue;
        }
        ...
        // 没有币账户就开通
        ExDigitalmoneyAccount exDigitalmoneyAccount = this
            .pushExDigitalmoneyAccount(customer, exProduct, website, currencyType);
        exDigitalmoneyAccountService.save(exDigitalmoneyAccount);
        System.out.println("虚拟币账户ID" + exDigitalmoneyAccount.getId());
  ...
  public ExDigitalmoneyAccount pushExDigitalmoneyAccount(AppCustomer customer, ExProduct exProduct,
      String website, String currencyType) {
    ...
    exDigitalmoneyAccount.setTrueName(personInfo.getTrueName());
    exDigitalmoneyAccount.setSurname(personInfo.getSurname());
    exDigitalmoneyAccount
        .setAccountNum(IdGenerate.accountNum(customer.getId().intValue(), exProduct.getCoinCode()));
