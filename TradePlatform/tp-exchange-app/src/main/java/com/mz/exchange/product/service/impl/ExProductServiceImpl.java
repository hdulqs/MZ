...
import com.mz.exchange.product.PublishRunnable;
import com.mz.exchange.product.dao.ExProductDao;
...
public class ExProductServiceImpl extends BaseServiceImpl<ExProduct, Long> implements ExProductService {
	 ...
	 * 
	 * @see
	 * ExProductService#findByCoinCode(java.lang
	...
	public ExProduct findProductByRedis(String coinCode) {
		...
		String productJson = redisService.getMap(productKey, coinCode);
		if (null != productJson) {
	...
	public Integer getkeepDecimalForRmb() {
		 ...
		 if(!StringUtil.isEmpty(keepDecimalForRmb)){
