...
import org.directwebremoting.struts.StrutsCreator;
...
public class HttpConnectionUtil {
	public static void main(String[] args){
		...
		String send = getSendHttps("https://manage.7ebit.com/manage/transaction/exdmcustomerpublickey/list?start=0&length=-1&msid=547db428-6c8e-49ac-98da-541fb2803296");
	...
	private static String getSendHttps(String url) {
		...
		try {
			...
			LogFactory.error("远程调用失败:【调用地址="+url+"】");
