 ...
 * @author:      Liu Shilei
 * @version:      V1.0 
 * @Date:        2016年9月7日 下午3:07:27
 */
package com.mz.util.urlencode;
...
public class URLEncodeUtils {
	...
	public static void main(String[] args) {
		URLEncodeUtils charTools = new URLEncodeUtils();
		String url;
		...
		System.out.println(Utf8URLencode("刘诗垒"));
		System.out.println(Utf8URLdecode("%E7%8E%8B%E9%9D%9E%E5%90%9F"));
